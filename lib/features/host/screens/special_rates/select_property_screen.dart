...
import 'special_rate_form_screen.dart';

class SelectPropertyForRateScreen extends StatelessWidget {
  const SelectPropertyForRateScreen({super.key});
          ...
          child: ListView.separated(
            ...
            itemBuilder: (ctx, i) => _PropertyCard(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => SpecialRateFormScreen(
